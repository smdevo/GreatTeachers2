        ...
        NavigationStack {
            ...
            VStack(alignment: .center, spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    DetailRow(icon: "person", label: "Username", value: teacher.username)
            ...
            .navigationTitle("Profile Teacher")
            ...
            .alert(isPresented: $showAlert) {
                Alert(title: Text("Delete Account"), message: Text("Do you want to delete your account"), primaryButton: .destructive(Text("Delete"), action: {
                    //vm.deletingTeacherbyID(id: teacher.id)
...
#Preview {
    TeacherProfileView(vm: HomeViewModel(), teacher: DEVPreViews.shared.teacher)
}
